...
### 问题 2：即便设备来自“已知设备全集”，Host 会不会把错误的那个给 pVM？
...
- `DEV_REQ_DMA` / `DEV_REQ_MMIO` 更像是在解决“第二个问题”；
- 对“第一类问题”（运行期新设备注入），还需要额外的 manifest / inventory 约束。
